...
?>
  ...
  <h1 style="text-align: center;">Listado de Visitas</h1>
    <!-- book a table Section  -->
    <div class="container-fluid has-bg-overlay text-center text-light has-height-lg middle-items" id="book-table">
        <div class="">

        <h6 class="section-secondary-title mt-5">LISTADO DE VISITAS</h6>
        
        <?php
            include_once "../conexion/conexion.php";
            $query="select v.id,u.nombre usuario,c.nombre comedor, v.fecha fechaVisita,v.procentaje,v.calificacion,v.observacion from visita v 
            JOIN asignacion a ON v.asiId=a.id 
            JOIN comedor c ON a.comId=c.id 
            JOIN usuarios u ON v.usuId=u.id;";
      ...
      <table class="table">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td><?php echo $consulta['comedor'] ?></td>
               <td><?php echo $consulta['fechaVisita'] ?></td>
               <td><?php echo $consulta['procentaje'] ?></td>
               <td><?php echo $consulta['calificacion'] ?></td>
               <td><?php echo $consulta['observacion'] ?></td>
               <td><a class="btn btn-warning" href="<?php echo "auditoria.php?id=" . $consulta['id']?>"><i class="ti-unlink"></i></a></td>
            </tr>
            <?php } ?>
         </tbody>
      </table>
